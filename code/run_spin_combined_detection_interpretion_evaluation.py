...
class Evaluator:
    ...
    Answer the following two questions with one JSON that contains the following keys:
    ...
    def __init__(self, model_name: str, output_path: str, input_path: str, is_debug: bool = False) -> None:
    ...
    def __clean_text(self, text: str) -> str:
        ...
        :return cleaned text
        """
        # just grab numerical number between 0 and 10
...
if __name__ == '__main__':
    ...
    evaluator = Evaluator(model_name, output_path, input_path, is_debug)
    evaluator.evaluate()
    gc.collect()
