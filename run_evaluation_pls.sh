...
for model in "${models[@]}"; do
  ...
  python3 code/run_spin_interpretation_from_pls_evaluation.py \
    --model "$model" \
    --input_path "code/pls_outputs/$model_outputs.csv" \
...
for model in "${models[@]}"; do
  ...
  python3 code/run_spin_interpretation_from_pls_evaluation.py \
    --model "$model" \
    --input_path "code/pls_outputs/$model_gold_labelled_outputs.csv" \
    --output_path "code/eval_outputs/$model" --debug
done
...
#   python3 code/run_spin_interpretation_from_pls_evaluation.py \
#     --model "$model" \
#     --input_path "code/pls_outputs/$model_model_output_labelled_outputs.csv" \
